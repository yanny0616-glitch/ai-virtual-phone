...
export type ToolEventEvent={id:string;messageId:string;sourceId:string;serverUrl:string;characterId:string;serverId:string;mode:"auto"|"receive";message:string;reason:string;createdAt:string};
export type ToolEventStatus={status:string;lastError:string;pending:number;config:null|{characterId:string;serverId:string;mode:"auto"|"receive";hasToken:boolean;serverUrl:string;adapter:"garden"|"webhook"};ingressToken?:string;sourceId?:string;acceptedIds?:string[];events?:ToolEventEvent[]};
