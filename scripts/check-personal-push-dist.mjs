...
for (const name of ["push-recheck", "push-generate"]) {
  ...
  for (const [label, path] of [["GUANIAN CLOUD HISTORY", "lib/guanian-cloud-history.ts"], ["GUANIAN PROMISES", "custom-apps/gua-nian/src/domain/promises.mjs"], ["GUANIAN MATTERS", "custom-apps/gua-nian/src/domain/matters.mjs"]]) {
