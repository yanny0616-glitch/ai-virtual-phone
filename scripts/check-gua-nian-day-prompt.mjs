...
const c=vm.createContext({console,Object,Array,String,Number,isFinite,cur:()=>null,hostCfg:()=>({mode:'cloud'}),cloudCfg:()=>null,serverBrainOn:()=>false,$:node,esc:s=>String(s).replace(/</g,'&lt;'),document:{querySelector:node,querySelectorAll:()=>[],body:{classList:{add(){},remove(){}}}},S:{settings:{},characters:[],order:[]}});
