...
| APP | 版本 | 做什么 | 说明文档 |
| --- | --- | --- | --- |
| 挂念 `gua-nian` | 0.9.39 | 生成角色一天（带到点揭晓的变数）→ 心动时刻 → 云端复核 → 定时主动消息；精力/情绪衰减模型；约定账本；可同时挂念多人；信息页按日程自动同步在线状态 | `custom-apps/gua-nian/ARCHITECTURE.md`、`docs/gua-nian-*.md`、`docs/archive/gua-nian/` |
